...
import 'package:flutter_devfest/registration/registration.dart';
        ...
        builder: (context, state) {
          return MaterialApp(
            ...
            routes: {
              ...
              SpeakerPage.routeName: (context) => HomePage(),
              AgendaPage.routeName: (context) => HomePage(),
              SponsorPage.routeName: (context) => RegistrationScreen(),
              TeamPage.routeName: (context) => HomePage(),
              FaqPage.routeName: (context) => HomePage(),
              FindDevFestPage.routeName: (context) => HomePage(),
              MapPage.routeName: (context) => HomePage(),
            },
          );
        },
      ),
